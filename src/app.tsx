...
function App() {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-neutral-900 px-10">
      <div className='absolute top-0 left-0 w-full h-16 bg-neutral-900 flex items-center justify-end'>

        <h1 className='w-fit mx-auto text-white text-sm'>DyWall: Create Own Dynamic Wallpapers</h1>
        <div
          onClick={() => {
            window.close();
          }}
      ...
      <div className='grid grid-cols-2 grid-rows-1 rounded-2xl overflow-hidden w-full mx-10'>
        <div onClick={() => document.getElementById("brightinput").click()} className='min-h-[200px] w-full bg-neutral-800 flex flex-col hover:bg-neutral-700 cursor-pointer items-center justify-center contents-center'>
          {
            bright_preview ? (
              <img src={bright_preview} className='w-full h-auto ' alt="Bright Wallpaper Preview" />
            ) : (<div className='flex flex-col items-center justify-center'>
              <MdBrightness7 className='text-neutral-500 text-4xl' />
              <h1 className='text-neutral-400 mt-2 text-lg'>Bright Wallpaper</h1>
              <input
                id='brightinput'
                type="file"
                accept="image/*"
        ...
        <div onClick={() => document.getElementById("darkinput").click()} className='min-h-[200px] w-full bg-neutral-800 hover:bg-neutral-700 cursor-pointer flex flex-col  items-center justify-center contents-center'>
          {
            dark_preview ? (
              <img src={dark_preview} className='w-full h-auto ' alt="Bright Wallpaper Preview" />
            ) : (<div className='flex flex-col items-center justify-center'>
              <MdBrightness7 className='text-neutral-500 text-4xl' />
              <h1 className='text-neutral-400 mt-2 text-lg'>Dark Wallpaper</h1>
              <input
                id='darkinput'
                type="file"
                accept="image/*"
      ...
      <div className='flex flex-row mx-auto w-fit mt-5'>
        <button
          ...
          className='bg-neutral-800 hover:bg-neutral-700 text-white rounded-l-full px-6 py-2 flex items-center gap-2'
        >
        ...
        <button
          onClick={async () => {
            const result = await window.Electron.ipcRenderer.invoke('create-wallpaper', [
              { path: bright_path, name: bright_path.split("/").at(-1) }, { path: dark_path, name: dark_path.split("/").at(-1) }
            ])
          ...
          className='bg-neutral-800 hover:bg-neutral-700 text-white rounded-r-full px-6 py-2 flex items-center gap-2'
        >
